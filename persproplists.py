# Name: Daniel Canton
# Program Purpose: This program uses lists to find the personqal property tax for vehicles in Charlottesville
...
#       --  Eligibility: Owned or leased vehicles which are predominately used for non-business purposes
#       --  Tax relief for qualified vehicles if 33%
...
def display_results():
    ...
    print (line)
    print ("********** PERSONAL PROPERTY REPORT **********")
